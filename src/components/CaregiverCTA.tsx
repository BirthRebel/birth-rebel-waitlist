  ...
  return (
    <section className="h-full flex items-center justify-center bg-caregiver-bg px-6">
      <div className="w-full max-w-4xl text-center">
        ...
        <p className="text-lg md:text-xl text-caregiver-text mb-8 max-w-3xl mx-auto leading-relaxed">
        ...
        <Button 
          className="bg-caregiver-cta text-white hover:bg-caregiver-cta/90"
          size="xl"
