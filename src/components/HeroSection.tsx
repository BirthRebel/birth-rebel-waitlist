    ...
    <section className="relative h-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center pt-32 md:pt-36 pb-16">
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed text-white/90">
          We connect expectant and new parents with experienced doulas, lactation consultants, sleep experts and hypnobirthing teachers, for virtual support, so you can get the right help at the right time.
        </p>
